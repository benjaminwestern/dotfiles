return {
  {
    ...
    opts = {
      ...
      spec = {
        ...
        -- ──────────────────────────────────────────
        -- EXPLORER / FILE BROWSERS
        -- ──────────────────────────────────────────
        {
          '<leader>n',
          desc = '📂 Yazi file browser at current file (floating)',
        },
        {
          '<leader>N',
          desc = '📂 Yazi file browser at project root',
        },
        ...
        -- ──────────────────────────────────────────
        -- GIT STATUS / LAZYGIT (floating terminal)
        -- ──────────────────────────────────────────
        {
          '<leader>g',
          group = '🔀 Git',
        ...
        {
          '<leader>gg',
          desc = 'Lazygit — full repo TUI in floating window',
        },
        {
          '<leader>gl',
          desc = 'Lazygit — git [l]og for current file',
        },
        {
          '<leader>gs',
