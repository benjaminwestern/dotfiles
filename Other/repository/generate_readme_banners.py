...
BANNERS: tuple[Banner, ...] = (
    ...
    Banner(
        ...
        subtitle="One public entry surface, one shared foundation layer, and one selected-stage personal layer.",
    ...
    Banner(
        ...
        eyebrow="tool split",
        subtitle="The mandatory macOS baseline lands first. Every optional catalogue and personal stage follows the selected plan.",
        chips=("homebrew", "mise"),
        accent="gold",
        index="04",
    ),
    ...
    Banner(
        ...
        subtitle="The bootstrap stands on Homebrew, Scoop, mise, and the rest of the toolchain.",
        chips=("tooling", "links"),
        accent="blue",
        index="08",
    ),
    ...
    Banner(
        ...
        subtitle="The shared install and repair sequence prepares the baseline, then hands selected stages to the personal layer.",
    ...
    Banner(
        ...
        subtitle="Focus the remaining work on second-machine validation, CI coverage, and keeping recovery paths aligned with the public loader.",
        chips=("ci", "bare metal"),
        accent="teal",
        index="23",
    ),
