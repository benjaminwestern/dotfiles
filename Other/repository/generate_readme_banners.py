...
BANNERS: tuple[Banner, ...] = (
    ...
    Banner(
        ...
        chips=("mise dotfiles", "copy rules"),
        variant="hero",
        accent="teal",
        index="30",
    ),
    ...
    Banner(
        ...
        subtitle="Mirror the target path, then wire the group into mise [dotfiles], the Linux symlink layer, or the Windows copy layer only when needed.",
